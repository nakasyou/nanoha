...
import type { NoteLoadType } from '../note/note-load-types.ts'
import { handleLoaded } from '../shared/q-utils.ts'
import { loadNoteFromType } from '../shared/storage.ts'
import { getGeminiApiToken } from '../shared/store.ts'
import { load } from '../note/utils/file-format/index.ts'
import type { MargedNote, NoteData } from '../note/components/notes-utils.ts'
import { generateWithLLM } from '../shared/ai.ts'
import { PROMPT_TO_GENERATE_QUESTION, QUESTION_SCHEMA, type Question } from './constants.ts'
import type { TextNoteCanToJsonData } from '../note/components/notes/TextNote/types.ts'
import TurndownService from 'turndown'
import { parse } from 'valibot'
import classNames from 'classnames'
import { wave } from '@ns/ha'
import iconSend from '@tabler/icons/outline/send.svg?raw'
import { removeIconSize } from '../note/utils/icon/removeIconSize.tsx'
