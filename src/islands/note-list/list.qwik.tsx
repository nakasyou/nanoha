...
export const NoteList = component$((props) => {
  ...
  return (
    <div>
      ...
      <div
        class={classnames([
          "fixed top-0 left-0 w-full h-[100dvh] z-20 transition-colors",
          {
      ...
      >
        <div
          class={classnames([
            "transition-transform duration-150 w-1/2 h-full rounded-l-3xl bg-background p-4 flex flex-col",
          ...
          <div class="grow flex items-center">
            <div class="grid grid-rows-2 rounded-3xl w-full">
              <button
                ...
                class={classnames("transition-colors p-2 rounded-t-3xl", {
              ...
              <button
                ...
                class={classnames("transition-colors p-2 rounded-b-3xl", {
                  "bg-secondary text-on-secondary": sortMode.value === "name",
                  "bg-surface text-on-surface border border-outlined": sortMode.value !== "name",
                })}
              >
                名前
              </button>
