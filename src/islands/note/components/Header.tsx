...
import IconEyeOff from "@tabler/icons/eye.svg?raw"
...
const Header = (props: Props) => {
  const [isNextShow, setIsNextShow] = createSignal(false)
  return (
    <div class="w-full lg:w-10 lg:px-2 py-1 z-30 h-auto lg:h-[100dvh]">
      <div class="flex justify-between items-center flex-row lg:flex-col h-full">
        ...
        <div>
          <div innerHTML={isNextShow() ? removeIconSize(IconEye) : removeIconSize(IconEyeOff)}></div>
        </div>
